...
$site_top = "http://united.nagoya/tetsuson/index.html";

// 管理者メールアドレス ※メールを受け取るメールアドレス(複数指定する場合は「,」で区切ってください 例 $to = "aa@aa.aa,bb@bb.bb";)
$to = "tetsuson2016shuttensha@gmail.com";
...
<title>CONTACT | TETSUSON2016</title>
<style type="text/css">
/* 自由に編集下さい */
footer{
  position: relative;
...
<header class="clearfix">
    <div id="inner">
    <h1><img src="../img/00_menu_logo.png" alt="TETSUSON"></h1>
    <nav>
      <ul class="clearfix">
        <li><a href="../../index.html"><img src="../img/00_menu_top.png" alt="top"></a></li>
        <li><a href="../html/about.html"><img src="../img/00_menu_about.png" alt="about"></a></li>
        <li><a href="../html/event.html"><img src="../img/00_menu_event.png" alt="event"></a></li>
        <li><a href="../html/sponsor.html"><img src="../img/00_menu_sponsor.png" alt="sponsor"></a></li>
        <li><a href="../html/entry.html"><img src="../img/00_menu_entry.png" alt="entry"></a></li>
      </ul>
    </nav>
    </div>
</header>
...
<article>
	<h1><img src="../img/05_h1.png" alt="entry"></h1>
	<h2><img src="../img/05-4_h2.png" alt=""></h2>
	...
	<div id="formWrap">
		...
		<p align="center" id="button" class="clearfix">
			...
			<input type="image" alt="戻る" src="../img/05-4_button_back.png" onclick="history.back()" onmouseover="this.src='../img/05-4_button_back_hover.png'" onmouseout="this.src='../img/05-4_button_back.png'" />
			<input type="image" alt="送信" src="../img/05-4_button_send.png" onmouseover="this.src='../img/05-4_button_send_hover.png'" onmouseout="this.src='../img/05-4_button_send.png'"/>
			<a href="#"><img src="../img/00_topback.png" alt="" id="topback"></a>
		</p>
		</form>
		<?php } ?>
	</div><!-- /formWrap -->
